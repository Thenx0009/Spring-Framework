...
public class Application {
	...
	private void createCourseAndStudents(AppDao appDAO) {
		...
		//create courses
		Course theCourse = new Course("Core Java");
		
		//create student
		Student theStudent1 = new Student("Ayush","verma","vermaayush32@gmail.com");
		Student theStudent2 = new Student("Mary","Tim","mary@gmail.com");
	...
	private void addMoreCoursesForStudent(AppDao appDAO) {
		...
		//add more courses for the student
		theStudent.addCourse(new Course("Rubik's Cube"));
		theStudent.addCourse(new Course("Atari 2600 - Game Development"));
	...
	private void deleteStudent(AppDao appDAO) {
		...
		System.out.println("Student deleted of the given id: "+theId);
	}
